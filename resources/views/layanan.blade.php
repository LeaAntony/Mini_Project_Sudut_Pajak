...
<div class="container mx-auto mb-40">
    ...
    <div class="grid grid-cols-2 gap-16 grid-rows-2">
        ...
        <a href="/bidang_usaha">
            <div
                class="card w-auto bg-base-100 shadow-xl mt-5 pt-14 pr-8 pb-36 pl-8 rounded relative duration-500 h-80 ">
                <p class="text-xl text-left font-bold text-bold-500">Kategori Perbidang Usaha</p>
                <p class="text-lg mt-7 text-sky-500">Memberikan layanan edukasi perpajakan yang terkait bidang-bidang
