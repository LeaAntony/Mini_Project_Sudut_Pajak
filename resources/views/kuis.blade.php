            ...
            <div class="card-body grid grid-rows-2">
                <div class="flex gap-5">
                    <span class="card-image inline-block">
                        <svg class="fill-cyan-500" id="kuis" height="64" viewBox="0 0 24 24" width="64" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
                ...
                <div class="card-actions self-end justify-end">
                    <a href="" class="btn bg-gradient-to-l from-emerald-500 to-blue-500 text-white px-10">
                        Lihat
                    </a>
                </div>
            </div>
