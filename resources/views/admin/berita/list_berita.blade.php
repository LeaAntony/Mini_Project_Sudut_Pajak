...
<div class="place-items-center">
    <div class="card bg-white shadow-xl mx-16 overflow-visible -mt-10">
        <div class="card-body">
            <x-link_button href="/admin/berita/tambah_berita" class="w-32 h-10 -mb-12 z-50">Tambah</x-link_button>
            <table id="data-tables" class="table bg-white z-0">
                ...
                <tbody>
                    ...
                    <tr class="hover">
                        ...
                        <td>Artikel</td>
                        <td>
                            <a href="/admin/berita/edit_berita"><i class="fi fi-rr-edit mx-2 text-blue-500"></i></a>
                            <a href="/admin/berita/hapus_berita"><i class="fi fi-rr-trash mx-2 text-red-400"></i></a>
                        </td>
                    </tr>
                    <!-- row 2 -->
                    <tr class="hover">
