...
<div class="flex flex-wrap -mx-4 card-wrapper">
    <div class="flex flex-wrap -mx-4">
        ...
        <div class="card bg-base-100 shadow-xl relative max-w-xs mx-auto mb-4 ml-4" onclick="window.location.href='video1'">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>Pengantar Hukum Pajak 7. Timbul dan Hilangnya Utang Pajak</strong></h2>
            </div>
             </div>
        <!--card3-->
        <div class="card bg-base-100 shadow-xl relative max-w-xs mx-auto mb-4 ml-4" onclick="window.location.href='video3'">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>PPh Pasal 21 TER atas Bonus dan THR (New 2024). Simak Videonya!</strong></h2>
            </div>
        </div>
        <!-- Card 4 -->
        ...
        <div style="width: 100%; overflow: hidden;">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>Cara Hitung dan Input PPh 21 atas THR di eBupot 21 tahun 2024</strong></h2>
            </div>
        </div>
        <!-- Card 5 -->
        ...
        <div style="width: 100%; overflow: hidden;">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>PPh Pasal 21 Pengertian dan tarifnya Simak Vdeo berikut untuk memahami lebih lanjut</strong></h2>
            </div>
        </div>
        <!-- Card 6 -->
        ...
        <div style="width: 100%; overflow: hidden;">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>cara hitung pph 21 pegawai tetap Simak video Berkut untuk mengetahui lebih lanjut</strong></h2>
            </div>
        </div>
        <!-- Card 7 -->
        ...
        <div style="width: 100%; overflow: hidden;">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>Terbaru! Simulasi Penghitungan Tarif Efektif Rata-rata (TER) PPh Pasal 21 tahun 2024</strong></h2>
            </div>
        </div>
        <!-- Card 8 -->
        ...
        <div style="width: 100%; overflow: hidden;">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>Simak Video berikut untuk mengethaui Cara Mudah Memahami PPh Pasal 21</strong></h2>
            </div>
        </div>
        <!-- Card 9 -->
        ...
        <div style="width: 100%; overflow: hidden;">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong>Simak Video berikut untuk mengetahui PPh Pasal 21 TER (Tarif Efektif Rata-rata) Tahun 2024</strong></h2>
            </div> 
        </div>
        <!-- Card 10 -->
        ...
        <div style="width: 100%; overflow: hidden;">
            ...
            <div class="card-body">
                <h2 class="card-title text-lg font-medium"><strong> Simak video ini untuk Menghitung PPh 21 Pegawai Masuk dan Berhenti Kerja di Tahun Berjalan</strong></h2>
            </div>
        </div>
    </div>
</div>
