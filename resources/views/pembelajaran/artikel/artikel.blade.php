...
<div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-2" style="margin-left: 10px;"> <!-- Gaya tambahan untuk memindahkan card ke kiri -->
        <div class="card-body">
        <h2 class="card-title text-lg font-medium"><strong>Pengaruh Pajak Penghasilan (PPh) terhadap Cash Flow UMKM dalam Industri Fashion</strong></h2>
            ...
            <p class="text-sm text-gray-600 mt-2">Pajak Penghasilan (PPh) merupakan kewajiban yang tak terhindarkan bagi Usaha Mikro, Kecil, dan Menengah
                ...
                kas, terutama jika tidak dikelola dengan bijak. <a href="/pembelajaran/artikel/detail" class="text-blue-500">Read
                    more</a></p>
    ...
    <!-- Artikel 2 -->
    <div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-2" style="margin-left: 10px;">
        <div class="card-body">
            ...
            <p class="text-sm text-gray-600 mt-2">Dalam era digital yang terus berkembang, UMKM (Usaha Mikro, Kecil, dan Menengah) dihadapkan pada tantangan baru dan peluang baru. Salah satu aspek penting yang perlu dipertimbangkan oleh UMKM adalah strategi pemasaran digital untuk meningkatkan visibilitas dan penjualan produk atau layanan mereka.
                Pemasaran digital telah menjadi kunci sukses bagi banyak UMKM dalam menghadapi persaingan di era digital ini. Dengan memanfaatkan berbagai platform dan teknik pemasaran digital.<a href="/pembelajaran/artikel/detail" class="text-blue-500"> Read more</a></p>
                    <div class="flex items-center mt-4 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path
    ...
    <div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-2" style="margin-left: 10px;" >
        <div class="card-body">
            ...
            <p class="text-sm text-gray-600 mt-2">Dalam menghadapi lingkungan bisnis yang semakin kompetitif, UMKM (Usaha Mikro, Kecil, dan Menengah) perlu mengembangkan strategi pemasaran yang inovatif guna memperkuat posisi mereka di pasar dan meningkatkan penjualan produk atau layanan.
                Salah satu langkah penting adalah memanfaatkan media konvensional secara optimal. UMKM dapat memilih saluran pemasaran yang sesuai dengan karakteristik produk atau layanan mereka, seperti iklan di koran lokal, majalah industri, atau pamflet yang didistribusikan di area strategis. <a href="/pembelajaran/artikel/detail" class="text-blue-500">Read
                    more</a></p>
                    <div class="flex items-center mt-4 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                    fill="currentColor">
    ...
    <div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-2" style="margin-left: 10px;">
        <div class="card-body">
            ...
            <p class="text-sm text-gray-600 mt-2">Dalam era globalisasi ini, kemitraan bisnis menjadi semakin penting bagi Usaha Mikro, Kecil, dan Menengah (UMKM) yang ingin 
                ...
                memiliki spesialisasi yang komplementer atau mitra distribusi yang dapat membantu mereka menjangkau pasar baru. Komunikasi yang terbuka dan jujur menjadi landasan yang penting dalam membangun hubungan yang kokoh.<a href="/pembelajaran/artikel/detail" class="text-blue-500"> Read
                    more</a></p>
                    <div class="flex items-center mt-4 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                    fill="currentColor">
    ...
    <!-- Artikel 5-->
    <div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-4" style="margin-left: 10px;">
        <div class="card-body">
            ...
            <p class="text-sm text-gray-600 mt-2">Dalam lingkungan Usaha Mikro, Kecil, dan Menengah (UMKM), peningkatan produktivitas kerja menjadi kunci utama untuk mencapai efisiensi dan kesuksesan bisnis. Salah satu strategi yang dapat 
                diterapkan adalah dengan menginvestasikan dalam teknologi yang tepat, seperti perangkat lunak manajemen proyek atau alat kolaborasi online, yang dapat mempermudah koordinasi antar tim dan mempercepat proses kerja. <a href="/pembelajaran/artikel/detail" class="text-blue-500">Read
                    more</a></p>
                    <div class="flex items-center mt-4 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                    fill="currentColor">
     ...
     <div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-4">
        <div class="card-body">
            ...
            <p class="text-sm text-gray-600 mt-2">Dalam konteks politik, perdebatan tentang pajak penghasilan merupakan topik yang selalu hangat. Reformasi pajak penghasilan, 
                 ...
                 hanya memengaruhi warga negara secara langsung, tetapi juga berdampak pada perekonomian secara keseluruhan. <a href="/pembelajaran/artikel/detail" class="text-blue-500"> Read
                    more</a></p>
                    <div class="flex items-center mt-4 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                    fill="currentColor">
    ...
    <div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-4">
        <div class="card-body">
            ...
            <p class="text-sm text-gray-600 mt-2">Dalam era digital ini, penggunaan teknologi berbasis cloud telah menjadi salah satu strategi yang efektif dalam meningkatkan efisiensi operasional Usaha Mikro, Kecil, dan Menengah (UMKM). Cloud computing menyediakan akses mudah dan fleksibel ke berbagai layanan IT, mulai 
                 penyimpanan data hingga aplikasi bisnis, tanpa perlu menginvestasikan biaya besar dalam infrastruktur IT. Salah satu manfaat utama dari teknologi cloud adalah kemampuannya untuk menyediakan penyimpanan data yang aman dan terjangkau <a href="/pembelajaran/artikel/detail" class="text-blue-500">Read
                    more</a></p>
                    <div class="flex items-center mt-4 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                    fill="currentColor">
    ...
    <div class="card bg-base-100 shadow-xl relative pl-4 pr-4 pt-2 pb-4 max-w-sm mx-auto mb-4 mr-4">
        <div class="card-body">
            ...
            <p class="text-sm text-gray-600 mt-2">Dalam konteks globalisasi dan transformasi digital yang terus berlangsung, Usaha Mikro, Kecil, dan Menengah (UMKM) menjadi bagian integral dari perekonomian modern.
                    ...
                    Salah satu tantangan utama yang dihadapi oleh UMKM adalah bagaimana mereka dapat memanfaatkan teknologi digital untuk meningkatkan visibilitas  <a href="/pembelajaran/artikel/detaile8" class="text-blue-500">Read
                    more</a></p>
                    <div class="flex items-center mt-4 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                    fill="currentColor">
