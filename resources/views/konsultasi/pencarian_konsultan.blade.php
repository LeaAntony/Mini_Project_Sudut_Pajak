...
<div class="flex flex-row">
    ...
    <div class="w-3/5 p-20 mx-auto">
        ...
        <a href="/konsultasi" class="btn bg-stone-300">Kembali</a>
        @forelse ($konsultan as $index => $data)
            <div class="flex mt-8">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm">{{ $data->alumnus_konsultan }}</p>
                    <p class="text-sm">{{ $data->jenjang_karir_konsultan }}</p></br>
                    <a href="{{ url('/konsultasi/'.$data->id_konsultan.'/profil_konsultan') }}" class="btn btn-info text-white btn-sm text-xs">Selengkapnya</a>
                </div>
            </div>
        @empty
