...
$.extend( true, DataTable.ext.classes, {
	...
	search: {
		input: "border bg-white placeholder-gray-500 ml-2 px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
	},
	length: {
	...
	paging: {
		active: 'font-semibold bg-gradient-to-r from-green-400 to-blue-500',
		notActive: 'bg-white',
