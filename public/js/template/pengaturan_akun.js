function showSection(section) {
    ...
    document.getElementById('fotoProfilSection').classList.add('hidden');
    ...
    document.getElementById('fotoProfilBtn').classList.remove('bg-gradient-to-r', 'from-green-400', 'to-teal-400',
        'hover:from-teal-300', 'hover:to-green-300', 'active:from-teal-200', 'active:to-green-200',
        'focus:outline-none', 'focus:ring', 'focus:ring-emerald-300', 'text-white');
